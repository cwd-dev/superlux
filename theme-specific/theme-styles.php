...
if (!function_exists('soleng_customizer_get_css')) {

	function soleng_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = soleng_customizer_add_theme_fonts($fonts);
...
.nav-links,
.page_links,
.post_header_meta .post_header_meta_left .post_categories,
.post_header_meta .post_header_meta_left .post_categories a,
.post_header_meta .post_header_meta_right .post_date a,
...
CSS;
			$rez = apply_filters('soleng_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(soleng_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = soleng_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = soleng_customizer_add_theme_colors($colors);
...
table th, table th + th, table td + th  {
	border-color: {$colors['bg_color_024']};
}
...
.widget.widget_recent_comments ul li:nth-child(2n+1) {
	background-color: {$colors['bg_color']};
}
...
input[type="search"]:not(.wp-block-search__input):hover,
...
.sidebar .select_container select:hover,
...
.sc_layouts_row_type_normal .sc_button.sc_button_simple {
...
.sc_layouts_title_breadcrumbs a:hover {
	color: {$colors['text_dark_065']} !important;
}
...
.sc_layouts_menu.alter .sc_layouts_menu_nav > li > a:hover,
.sc_layouts_menu.alter .sc_layouts_menu_nav > li.sfHover > a {
	color: {$colors['text_dark_065']} !important;
}
...
.sc_layouts_menu.alter .sc_layouts_menu_nav > li.current-menu-item > a,
.sc_layouts_menu.alter .sc_layouts_menu_nav > li.current-menu-parent > a,
.sc_layouts_menu.alter .sc_layouts_menu_nav > li.current-menu-ancestor > a {
	color: {$colors['text_dark_065']} !important;
}
...
.sc_layouts_cart .sc_layouts_item_icon:hover {
	color: {$colors['text_dark_065']};
}

.sc_layouts_cart .sc_layouts_item_details:hover > *{
	color: {$colors['text_dark_065']};
}
...
.soleng_tabs .soleng_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.soleng_tabs .soleng_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sheme_self.sidebar .soleng_tabs .soleng_tabs_titles li.ui-state-active a {
...
.post_header_meta .post_header_meta_right .post_date a:hover {
	color: {$colors['text_hover2']};
}
...
.mejs-controls .mejs-horizontal-volume-slider .mejs-horizontal-volume-total {
	background: {$colors['inverse_link_035']};
}
...
.post_item_single .post_content > .post_meta_single .post_share .socials_share .socials_caption,
.post_item_single .post_content > .post_meta_single .post_share .socials_share .socials_caption:hover,
...
.sidebar .tourmaster-form-field input[type="text"],
.sidebar .tourmaster-form-field input[type="email"],
.sidebar .tourmaster-form-field input[type="password"],
.sidebar .tourmaster-form-field textarea,
.sidebar .tourmaster-form-field select,
.sidebar .tourmaster-form-field.tourmaster-with-border input[type="text"],
.sidebar .tourmaster-form-field.tourmaster-with-border input[type="email"],
.sidebar .tourmaster-form-field.tourmaster-with-border input[type="password"],
.sidebar .tourmaster-form-field.tourmaster-with-border textarea,
.sidebar .tourmaster-form-field.tourmaster-with-border select,
.sidebar .woocommerce table.cart td.actions .coupon .input-text,
.sidebar .woocommerce #content table.cart td.actions .coupon .input-text,
.sidebar .woocommerce-page table.cart td.actions .coupon .input-text,
.sidebar .woocommerce-page #content table.cart td.actions .coupon .input-text,
.sidebar #buddypress div.dir-search input[type="search"],
.sidebar #buddypress div.dir-search input[type="text"],
.sidebar #buddypress li.groups-members-search input[type="search"],
.sidebar #buddypress li.groups-members-search input[type="text"],
.sidebar #buddypress .standard-form input[type="color"],
.sidebar #buddypress .standard-form input[type="date"],
.sidebar #buddypress .standard-form input[type="datetime-local"],
.sidebar #buddypress .standard-form input[type="datetime"],
.sidebar #buddypress .standard-form input[type="email"],
.sidebar #buddypress .standard-form input[type="month"],
.sidebar #buddypress .standard-form input[type="number"],
.sidebar #buddypress .standard-form input[type="password"],
.sidebar #buddypress .standard-form input[type="range"],
.sidebar #buddypress .standard-form input[type="search"],
.sidebar #buddypress .standard-form input[type="tel"],
.sidebar #buddypress .standard-form input[type="text"],
.sidebar #buddypress .standard-form input[type="time"],
.sidebar #buddypress .standard-form input[type="url"],
.sidebar #buddypress .standard-form input[type="week"],
.sidebar #buddypress .standard-form select,
.sidebar #buddypress .standard-form textarea {
	color: {$colors['alter_text']};
	border-color: {$colors['bg_color']};
	background-color: {$colors['bg_color']};
}
...
.sidebar textarea.wp-editor-area:focus,
.sidebar form.mc4wp-form .mc4wp-form-fields input[type="email"]:focus,
.sidebar .tourmaster-form-field input[type="text"]:focus,
.sidebar .tourmaster-form-field input[type="email"]:focus,
.sidebar .tourmaster-form-field input[type="password"]:focus,
.sidebar .tourmaster-form-field textarea:focus,
.sidebar .tourmaster-form-field select:focus,
.sidebar .tourmaster-form-field.tourmaster-with-border input[type="text"]:focus,
.sidebar .tourmaster-form-field.tourmaster-with-border input[type="email"]:focus,
.sidebar .tourmaster-form-field.tourmaster-with-border input[type="password"]:focus,
.sidebar .tourmaster-form-field.tourmaster-with-border textarea:focus,
.sidebar .tourmaster-form-field.tourmaster-with-border select:focus,
.sidebar .woocommerce table.cart td.actions .coupon .input-text:focus,
.sidebar .woocommerce #content table.cart td.actions .coupon .input-text:focus,
.sidebar .woocommerce-page table.cart td.actions .coupon .input-text:focus,
.sidebar .woocommerce-page #content table.cart td.actions .coupon .input-text:focus,
.sidebar #buddypress div.dir-search input[type="search"]:focus,
.sidebar #buddypress div.dir-search input[type="text"]:focus,
.sidebar #buddypress li.groups-members-search input[type="search"]:focus,
.sidebar #buddypress li.groups-members-search input[type="text"]:focus,
.sidebar #buddypress .standard-form input[type="color"]:focus,
.sidebar #buddypress .standard-form input[type="date"]:focus,
.sidebar #buddypress .standard-form input[type="datetime-local"]:focus,
.sidebar #buddypress .standard-form input[type="datetime"]:focus,
.sidebar #buddypress .standard-form input[type="email"]:focus,
.sidebar #buddypress .standard-form input[type="month"]:focus,
.sidebar #buddypress .standard-form input[type="number"]:focus,
.sidebar #buddypress .standard-form input[type="password"]:focus,
.sidebar #buddypress .standard-form input[type="range"]:focus,
.sidebar #buddypress .standard-form input[type="search"]:focus,
.sidebar #buddypress .standard-form input[type="tel"]:focus,
.sidebar #buddypress .standard-form input[type="text"]:focus,
.sidebar #buddypress .standard-form input[type="time"]:focus,
.sidebar #buddypress .standard-form input[type="url"]:focus,
.sidebar #buddypress .standard-form input[type="week"]:focus,
.sidebar #buddypress .standard-form select:focus,
.sidebar #buddypress .standard-form textarea:focus{
	color: {$colors['alter_dark']};
	border-color: {$colors['bg_color']};
	background-color: {$colors['bg_color']};
}

.sidebar input::-webkit-input-placeholder {color:{$colors['alter_text']} !important;}
.sidebar input::-moz-placeholder {color:{$colors['alter_text']} !important;}
.sidebar input:-moz-placeholder {color:{$colors['alter_text']} !important;}
.sidebar input:-ms-input-placeholder {color:{$colors['alter_text']} !important;}
.sidebar select:-ms-input-placeholder {color:{$colors['alter_text']} !important;}
.sidebar select::-webkit-input-placeholder {color:{$colors['alter_text']} !important;}
.sidebar select::-moz-placeholder {color:{$colors['alter_text']} !important;}
.sidebar select:-moz-placeholder {color:{$colors['alter_text']} !important;}
.sidebar textarea::-webkit-input-placeholder {color:{$colors['alter_text']} !important;}
.sidebar textarea::-moz-placeholder {color:{$colors['alter_text']} !important;}
.sidebar textarea:-moz-placeholder {color:{$colors['alter_text']} !important;}
.sidebar textarea:-ms-input-placeholder {color:{$colors['alter_text']} !important;}
1
...
.footer_wrap .widget.widget_recent_comments ul li:nth-child(2n+0),
.scheme_self.footer_wrap .widget.widget_recent_comments ul li:nth-child(2n+0) {
	background-color: {$colors['alter_bg_color']};
}
...
CSS;
					...
					$rez = apply_filters('soleng_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'soleng_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>