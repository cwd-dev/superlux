...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Soleng'.
Please install and activate it before starting to use the theme Soleng.
Also the theme supports many popular plugins such as 'Revolution Slider', 'WPBakery PageBuilder', 'WooCommerce'
and many more.


III. Documentation

Theme documentation is available on http://soleng.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Soleng is Fontello.
