...
if (!function_exists('soleng_trx_addons_get_css')) {
	add_filter('soleng_filter_get_css', 'soleng_trx_addons_get_css', 10, 4);
	function soleng_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.socials_wrap .social_item.contacts_socials_label,
...
.swiper-pagination-custom .swiper-pagination-button.swiper-pagination-button-active:after {
	background-color: {$colors['text_link2_06']};
}
...
.sc_title_title:after {
	background-color: {$colors['text_link2']};
}
.color_style_dark .sc_title_title:after {
	background-color: {$colors['text_dark']};
}

.color_style_dark .sc_item_descr {
	color: {$colors['text_dark']};
}
...
.sc_action .sc_action_content .sc_action_item .sc_action_item_inner .sc_action_item_link:hover {
	color:{$colors['inverse_link']}; 
	background-color:{$colors['text_link']}; 
}
...
.sc_blogger .sc_blogger_item .post_date a:hover{
	color: {$colors['alter_hover2']};
}
.sc_blogger .sc_blogger_item a.post_author{
	color: {$colors['alter_text']};
}
.sc_blogger .sc_blogger_item a.post_author:hover{
	color: {$colors['alter_hover2']};
}
...
.sc_icons.sc_icons_modern .alter_border_color .sc_icon_item_number {
	border-color: {$colors['alter_bg_color']};
}
...
.sc_services_iconed .sc_services_item .sc_services_item_content{
	color: {$colors['alter_text']};
}
...
.sc_services.sc_services_iconed .sc_services_item_header a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_hover']};
}
.sc_services.sc_services_iconed .sc_services_item:hover .sc_services_item_header a span{
	color: {$colors['inverse_link']};
}
...
.sc_services_image .sc_services_item .sc_services_item_info .sc_services_item_title a{
	color: {$colors['inverse_link']};
}
.sc_services_image .sc_services_item .sc_services_item_info .sc_services_item_title a:hover{
	color: {$colors['inverse_dark']};
}
...
.sc_services.sc_services_listing .sc_services_item .sc_services_icon_title a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_hover']};
}
.sc_services.sc_services_listing .sc_services_item .sc_services_item_title a{
	color: {$colors['text']};
}
.sc_services.sc_services_listing .sc_services_item .sc_services_item_title a:hover{
	color: {$colors['text_hover']};
}
...
.scheme_self.sc_testimonials .sc_testimonials_item_content:before{
	color: {$colors['text_dark']};
}
.scheme_self.sc_testimonials .sc_testimonials_item_content{
	color: {$colors['text_dark_07']};
}
.scheme_self.sc_testimonials .sc_testimonials_item_author_title{
	color: {$colors['text_dark']};
}
.scheme_self.sc_testimonials .swiper-pagination-custom .swiper-pagination-button:hover::after, 
.scheme_self.sc_testimonials .swiper-pagination-custom .swiper-pagination-button.swiper-pagination-button-active:after{
...
.sc_team_default .sc_team_item_info .sc_team_item_title a{
	color: {$colors['alter_link2']};
}
.sc_team_default .sc_team_item_info .sc_team_item_title a:hover{
	color: {$colors['alter_hover2']};
}
...
.post_info .post_info_item.post_info_posted .post_info_date:hover {
	color: {$colors['alter_dark']};
}
...
.wpcf7-form .color_alter input,
.scheme_self.vc_row .wpcf7-form .color_alter input,
.wpcf7-form .color_alter select,
.scheme_self.vc_row .wpcf7-form .color_alter select,
.wpcf7-form .color_alter .select_container,
.scheme_self.vc_row .wpcf7-form .color_alter .select_container,
.wpcf7-form .color_alter textarea,
.scheme_self.vc_row .wpcf7-form .color_alter textarea {
	color: {$colors['text_dark']};
	border-color: transparent !important;
	background-color: {$colors['text_dark_02']} !important;
}
.wpcf7-form .color_alter option,
.scheme_self.vc_row .wpcf7-form .color_alter option {
	color: {$colors['inverse_dark']};
	border-color: transparent !important;
	background-color: {$colors['text_dark_02']} !important;
}
.wpcf7-form .color_alter input[type="submit"],
.scheme_self.vc_row .wpcf7-form .color_alter input[type="submit"]{
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']} !important;	
}
.wpcf7-form .color_alter input[type="submit"]:hover,
.scheme_self.vc_row .wpcf7-form .color_alter input[type="submit"]:hover{
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']} !important;
}
.wpcf7-form .color_alter input:hover,
.scheme_self.vc_row .wpcf7-form .color_alter input:hover,
.wpcf7-form .color_alter select:hover,
.scheme_self.vc_row .wpcf7-form .color_alter select:hover,
.wpcf7-form .color_alter .select_container:hover,
.scheme_self.vc_row .wpcf7-form .color_alter .select_container:hover,
.wpcf7-form .color_alter textarea:hover,
.scheme_self.vc_row .wpcf7-form .color_alter textarea:hover,
.wpcf7-form .color_alter input:focus,
.scheme_self.vc_row .wpcf7-form .color_alter input:focus,
.wpcf7-form .color_alter select:focus,
.scheme_self.vc_row .wpcf7-form .color_alter select:focus,
.wpcf7-form .color_alter .select_container:focus,
.scheme_self.vc_row .wpcf7-form .color_alter .select_container:focus,
.wpcf7-form .color_alter textarea:focus,
.scheme_self.vc_row .wpcf7-form .color_alter textarea:focus{
	color: {$colors['text_dark']};
	border-color: {$colors['text_dark']} !important;
	background-color: transparent !important;
}
.wpcf7-form .color_alter input[type="submit"]:focus{
	color: {$colors['text_dark']};
	border-color: {$colors['text_link']} !important;
	background-color: {$colors['text_link']} !important;
}
.wpcf7-form .color_alter .select_container select,
.scheme_self.vc_row .wpcf7-form .color_alter .select_container select{
	background-color: transparent !important;
}
.wpcf7-form .color_alter input,
.scheme_self.vc_row .wpcf7-form .color_alter input {
...
.wpcf7-form .color_alter input::-webkit-input-placeholder {color: {$colors['text_dark']} !important;}
.wpcf7-form .color_alter input::-moz-placeholder          {color: {$colors['text_dark']} !important;}
.wpcf7-form .color_alter input:-moz-placeholder           {color: {$colors['text_dark']} !important;}
.wpcf7-form .color_alter input:-ms-input-placeholder      {color: {$colors['text_dark']} !important;}
.wpcf7-form .color_alter textarea::-webkit-input-placeholder {color: {$colors['text_dark']} !important;}
.wpcf7-form .color_alter textarea::-moz-placeholder          {color: {$colors['text_dark']} !important;}
.wpcf7-form .color_alter textarea:-moz-placeholder           {color: {$colors['text_dark']} !important;}
.wpcf7-form .color_alter textarea:-ms-input-placeholder      {color: {$colors['text_dark']} !important;}
.scheme_self.vc_row .wpcf7-form .color_alter input::-webkit-input-placeholder {color: {$colors['text_dark']} !important;}
.scheme_self.vc_row .wpcf7-form .color_alter input::-moz-placeholder          {color: {$colors['text_dark']} !important;}
.scheme_self.vc_row .wpcf7-form .color_alter input:-moz-placeholder           {color: {$colors['text_dark']} !important;}
.scheme_self.vc_row .wpcf7-form .color_alter input:-ms-input-placeholder      {color: {$colors['text_dark']} !important;}
.scheme_self.vc_row .wpcf7-form .color_alter textarea::-webkit-input-placeholder {color: {$colors['text_dark']} !important;}
.scheme_self.vc_row .wpcf7-form .color_alter textarea::-moz-placeholder          {color: {$colors['text_dark']} !important;}
.scheme_self.vc_row .wpcf7-form .color_alter textarea:-moz-placeholder           {color: {$colors['text_dark']} !important;}
.scheme_self.vc_row .wpcf7-form .color_alter textarea:-ms-input-placeholder      {color: {$colors['text_dark']} !important;}
